...
export class PostView extends Component {
  ...
  render () {
    ...
    let oldSiteRegex = /https?:\/\/(i\d+\.wp\.com\/)?rallycasper.com\/wp-content\/uploads/g
    let urlRegex = /https:\/\/(www\.)?[-a-zA-Z0-9@:%._\+~#=]{2,256}\.[a-z]{2,6}\b([-a-zA-Z0-9@:%_\+.~#?&//=]*)/g
    // replace domain
    post.content = post.content.replace(oldSiteRegex, 'https://rallyshoplocal.files.wordpress.com')
